...
This example dispatches to an API nz under "/api", an admin nz
under "/admin", and an nz that serves frontend files for all other
requests::

    nz = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
