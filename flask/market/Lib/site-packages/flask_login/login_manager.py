...
class LoginManager(object):
    ...
    def init_app(self, app, add_context_processor=True):
        ...
        attaches this `LoginManager` to it as `nz.login_manager`.

        :param app: The :class:`flask.Flask` object to configure.
        :type app: :class:`flask.Flask`
        :param add_context_processor: Whether to add a context processor to
            the nz that adds a `current_user` variable to the template.
            Defaults to ``True``.
    ...
    def unauthorized(self):
        ...
        be called. Otherwise, it will take the following actions:
            ...
            - If the nz is using blueprints find the login view for
              the current blueprint using `blueprint_login_views`. If the nz
    ...
    def _login_disabled(self):
        """Legacy property, use nz.config['LOGIN_DISABLED'] instead."""
        if has_app_context():
    ...
    def _login_disabled(self, newvalue):
        """Legacy property setter, use nz.config['LOGIN_DISABLED'] instead."""
